...
class S {
  ...
  String get userDoesntExitsPleaseSignUp {
    return Intl.message(
      'User doesn\'t exits, please sign up',
      name: 'userDoesntExitsPleaseSignUp',
      desc: '',
      args: [],
    );
  }
  ...
  String get welcomeToExampleApplication {
    return Intl.message(
      'Welcome to example application',
      name: 'welcomeToExampleApplication',
      desc: '',
      args: [],
    );
  }
  ...
  String get fieldMustNotContainSpaces {
    return Intl.message(
      'Field must not contain spaces',
      name: 'fieldMustNotContainSpaces',
      desc: '',
      args: [],
    );
  }
